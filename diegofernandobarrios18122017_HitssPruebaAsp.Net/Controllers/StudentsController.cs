...
namespace diegofernandobarrios18122017_HitssPruebaAsp.Net.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DocumentType,IdDocument,Name,Lastname,Gender")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DocumentType,IdDocument,Name,Lastname,Gender")] Student student)
        {
            if (ModelState.IsValid)
            {
